...
Additionally, they can be adapted to other security system designs within the complex infrastructures of autonomous vehicle networks, ensuring a more secure data processing.
...
In the next sections\ref{sec:cybersecurity-threats-in-autonomous-vehicles} there will be a deep dive into the main sensors used in AVs and their vulnerabilities.
