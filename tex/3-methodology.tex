...
In this review,
I aim to provide a comprehensive overview of the current state of research on security in autonomous vehicles.
...
\begin{enumerate}
    \item \textit{autonomous vehicles security threats}
    \item \textit{autonomous vehicles cybersecurity standards}
    \item \textit{autonomous vehicles industry practices}
    \item \textit{autonomous vehicles future trends cybersecurity}
